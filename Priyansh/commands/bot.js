...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("My Owner AestHetic bOy Ayush Shukla🖤", threadID);
   };
...
if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
   ...
   if ((event.body.toLowerCase() == "Raja") || (event.body.toLowerCase() == "Shubham") || (event.body.toLowerCase() == "subham") || (event.body.toLowerCase() == "shubham")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "create you")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟💙Raja  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐌𝐫Aadi. 𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/subham.verma.7311352", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("MrRaja ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Raha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "botka admin kon ha")) {
     return api.sendMessage("He is Aadi. He Gives his name MrAadi everywhare", threadID);
   };

   if ((event.body.toLowerCase() == "Dutta") || (event.body.toLowerCase() == "dutta")) {
     return api.sendMessage("ye🤗 toh 💃hasina h. 🥀meri jaan🌹 h. meri😍 dil 😍ki 😘dhadkan🤩 h🤩.MrRaja 😚babu ki💝 Dil Ki Chain💘 Hai Dutta🥰 Umaah😘😋", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
     return api.sendMessage("srry malik🥺 maaf🙏 kr do ab nhi krugi 🥀MrRaJa🌹 babu💝", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Raju") || (event.body.toLowerCase() =="Raja")) {
